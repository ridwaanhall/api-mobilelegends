...
def roles(
    ...
    order: Annotated[
        Literal["asc", "desc"],
        Query(description="Sort order for role IDs."),
    ] = "asc",
    lang: Annotated[
        str,
        Query(
...
def recommended(
    ...
    order: Annotated[
        Literal["asc", "desc"],
        Query(description="Sort order for recommendation hotness and creation time."),
    ] = "desc",
...
def guide(
    ...
    order: Annotated[
        Literal["asc", "desc"],
        Query(description="Sort order for hero IDs."),
    ] = "desc",
    lang: Annotated[
        str,
        Query(
